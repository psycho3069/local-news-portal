...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.video-galleries.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control @error('video_type') is-invalid @enderror" 
                            ...
                            <option value="local" {{ old('video_type') == 'local' ? 'selected' : '' }}>Local/Other</option>
                        </select>
                        @error('video_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-block">
                            <i class="fa fa-save"></i> Add Video
                        </button>
                    </div>
                </div>
            </div>

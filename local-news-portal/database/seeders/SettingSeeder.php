...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'site_name_bn', 'value' => 'দ্যা নিউজ নারায়ণগঞ্জ ডটকম', 'type' => 'text', 'group' => 'general'],
            ...
            ['key' => 'editor_name', 'value' => 'শাহজাহান শামীম', 'type' => 'text', 'group' => 'general'],
            ['key' => 'contact_phone', 'value' => '+৮৮-০২-৯৮৪৫৪০৮', 'type' => 'text', 'group' => 'contact'],
            ['key' => 'contact_email', 'value' => 'info@newsnarayanganj.com', 'type' => 'text', 'group' => 'contact'],
            ['key' => 'contact_address', 'value' => '১৯৩ প্রেসিডেন্ট রোড, সিরাজ ম্যানশন, চাষাঢ়া, নারায়ণগঞ্জ।', 'type' => 'text', 'group' => 'contact'],
            ['key' => 'facebook_url', 'value' => 'https://web.facebook.com/newsnarayanganjdotcom', 'type' => 'text', 'group' => 'social'],
            ['key' => 'twitter_url', 'value' => 'https://twitter.com/newsnarayanganj', 'type' => 'text', 'group' => 'social'],
            ['key' => 'youtube_url', 'value' => 'https://www.youtube.com/@newsnarayanganj', 'type' => 'text', 'group' => 'social'],
